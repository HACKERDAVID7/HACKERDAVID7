...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3000&pause=1000&color=00FEEF&center=true&vCenter=true&width=435&lines=Data+Scientist+%F0%9F%8C%90;ML+Engineer+%7C+Python+%7C+Power+BI;Always+Learning+%E2%9C%A8;Open+Source+Explorer+%F0%9F%94%A5" alt="Typing SVG" />
</p>
...
- 🌱 Constantly learning and growing in the areas of **deep learning, web deployment**, and **data engineering**.
- 📚 Completed various certifications from **IBM**, **AWS**, and **Simplilearn** to sharpen my data science toolkit.
- 🌐 I enjoy translating raw data into actionable insights that drive results.
...
![Scikit-Learn](https://img.shields.io/badge/Scikit--Learn-F7931E?style=social&logo=scikit-learn&logoColor=white)
...
- 🔍 [**Customer Segmentation (K-Means Clustering)**](https://github.com/HACKERDAVID7/CipherSchools-Project)  
  Identified 5 unique customer segments for targeted marketing using age, income, and spending behavior.

- 🌱 [**Plant Classification (CNN + Flask)**](https://github.com/HACKERDAVID7/PlantClassification)  
  Built and deployed a CNN model for classifying plants via a Flask web app.

- ❤️ [**Heart Disease Detection (RapidMiner)**](https://github.com/HACKERDAVID7/HeartDiseasePrediction)  
  Created an ML pipeline to predict cardiovascular diseases using key medical indicators.
...
- ✅ **AWS Machine Learning Basics** – AWS  
- ✅ **Integrated Python, ML & Data Science** – CipherSchools
